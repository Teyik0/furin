...
export const DOCS_NAV: DocNavSection[] = [
  {
    items: [
      ...
      {
        description: "Choose between Furin, Next.js, and TanStack Start from concrete tradeoffs.",
  ...
  },
  {
    items: [
      ...
      {
        description: "Typed links, search state, preloading, refresh, and scroll behaviour.",
      ...
      {
        description: "error.tsx, not-found.tsx, notFound(), safe messages, and recovery.",
      ...
      {
        description: "Titles, metadata, canonical links, JSON-LD, styles, and scripts.",
  ...
  },
  {
    items: [
      {
        description: "Server loaders, typed params/query, parent data, and request-only data.",
      ...
      {
        description: "Stream explicitly deferred loader fields through React Suspense.",
      ...
      {
        description: "Choose SSR, SSG, or ISR explicitly for every route.",
      ...
      {
        description: "Understand route caches, ETags, tags, and on-demand invalidation.",
  ...
  },
  {
    items: [
      ...
      {
        description: "Add idempotent mutations and cross-client cache invalidation.",
        githubPath: "apps/docs/src/content/docs/sync.mdx",
        href: "/docs/sync",
        label: "Sync & Invalidations",
        openIn: DEFAULT_OPEN_IN,
        sourcePath: "src/content/docs/sync.mdx",
      ...
      {
        description: "Deploy Bun servers, binaries, static exports, or packaged Furin apps.",
      ...
      {
        description: "Reference every furin.config.ts field and its precedence.",
      ...
      {
        description: "Build and preview commands, flags, targets, and output locations.",
...
export function buildOpenInUrl(
  ...
  switch (target) {
    case "github":
      return `https://github.com/teyik0/furin/blob/main/${doc.githubPath}`;
    case "chatgpt":
