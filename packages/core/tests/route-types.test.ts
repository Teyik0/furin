...
describe("writeRouteTypes", () => {
  ...
  test("creates routes.d.ts with the correct module declaration", () => {
    ...
    expect(content).toContain("Auto-generated by Elysion");
    expect(content).toContain('import "@teyik0/elysion/link"');
    expect(content).toContain('declare module "@teyik0/elysion/link"');
