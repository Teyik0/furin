...
import { RouterProvider } from "@teyik0/elysion/link";
...
/**
 * Generates .elysion/routes.d.ts — augments RouteManifest in @teyik0/elysion/link
 * so that <Link to="..."> has type-safe autocompletion and <Link search={...}>
 * is typed per-route from the route's query schema.
 *
 * Users must add ".elysion/routes.d.ts" to their tsconfig.json "include" array once.
 */
/** @internal Exported for unit testing only. */
export function writeRouteTypes(routes: ResolvedRoute[], outDir: string): void {
  ...
  const content = `// Auto-generated by Elysion. Do not edit manually.
// Add ".elysion/routes.d.ts" to your tsconfig.json "include" array to enable typed navigation.
...
export function writeDevFiles(routes: ResolvedRoute[], options: BuildClientOptions = {}): void {
  ...
  console.log(
    "[elysion] Dev files written (.elysion/_hydrate.tsx + .elysion/index.html + .elysion/routes.d.ts)"
  );
}
